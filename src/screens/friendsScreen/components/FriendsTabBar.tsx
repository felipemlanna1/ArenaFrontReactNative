...
export type FriendTab = 'friends' | 'incoming' | 'outgoing' | 'recommendations';
...
export const FriendsTabBar: React.FC<FriendsTabBarProps> = ({
  activeTab,
  onTabChange,
  friendsCount,
  incomingCount,
  ...
  return (
    <View style={styles.container} testID="friends-tab-bar">
