...
import { ComponentsShowcaseScreenProps, ComponentSectionProps, ShowcaseItemProps } from './typesComponentsShowcaseScreen';
...
const ShowcaseItem: React.FC<ShowcaseItemProps> = ({ label, description, children }) => {
  return (
